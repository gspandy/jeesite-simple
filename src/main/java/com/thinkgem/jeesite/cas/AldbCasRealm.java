...
public class AldbCasRealm extends CasRealm {
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        SimpleAuthorizationInfo info = (SimpleAuthorizationInfo) CacheUtils.get("authCache", principal.getLoginName());
        if (info != null) {
            return info;
        }
        ...
        if (user != null) {
            ...
            CacheUtils.put("authCache", principal.getLoginName(), info);
            return info;
        } else {
            return null;
        }
